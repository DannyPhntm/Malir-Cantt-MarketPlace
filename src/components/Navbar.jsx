...
export default function Navbar() {
  ...
  // Lock background scroll while the mobile menu is open. Uses the position:fixed
  // technique (not just overflow:hidden) because iOS Safari ignores overflow:hidden
  // on body — the page keeps scrolling behind overlays otherwise. The menu itself
  // is a fixed, internally-scrollable panel (see Navbar.css). Scroll position is
  // saved and restored so closing the menu returns the user where they were.
  useEffect(() => {
    if (!menuOpen) return;
